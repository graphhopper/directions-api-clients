...
public class IsochroneApi {
    ...
    private com.squareup.okhttp.Call isochroneGetCall(String point, String key, Integer timeLimit, String vehicle, Integer buckets, Boolean reverseFlow, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call isochroneGetValidateBeforeCall(String point, String key, Integer timeLimit, String vehicle, Integer buckets, Boolean reverseFlow, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = isochroneGetCall(point, key, timeLimit, vehicle, buckets, reverseFlow, progressListener, progressRequestListener);
        return call;
     ...
     */
    public GHIsochroneResponse isochroneGet(String point, String key, Integer timeLimit, String vehicle, Integer buckets, Boolean reverseFlow) throws ApiException {
        ApiResponse<GHIsochroneResponse> resp = isochroneGetWithHttpInfo(point, key, timeLimit, vehicle, buckets, reverseFlow);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GHIsochroneResponse> isochroneGetWithHttpInfo(String point, String key, Integer timeLimit, String vehicle, Integer buckets, Boolean reverseFlow) throws ApiException {
        com.squareup.okhttp.Call call = isochroneGetValidateBeforeCall(point, key, timeLimit, vehicle, buckets, reverseFlow, null, null);
     ...
     */
    public com.squareup.okhttp.Call isochroneGetAsync(String point, String key, Integer timeLimit, String vehicle, Integer buckets, Boolean reverseFlow, final ApiCallback<GHIsochroneResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = isochroneGetValidateBeforeCall(point, key, timeLimit, vehicle, buckets, reverseFlow, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GHIsochroneResponse>(){}.getType();
