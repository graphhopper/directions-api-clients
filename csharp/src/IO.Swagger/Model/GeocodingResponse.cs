...
namespace IO.Swagger.Model
{
        ...
        public partial class GeocodingResponse :  IEquatable<GeocodingResponse>, IValidatableObject
    {
        ...
        /// <param name="took">in ms.</param>
        public GeocodingResponse(List<GeocodingLocation> hits = default(List<GeocodingLocation>), decimal? took = default(decimal?))
        {
            this.Hits = hits;
            this.Took = took;
        }
        ...
        {
            return this.Equals(input as GeocodingResponse);
        }
