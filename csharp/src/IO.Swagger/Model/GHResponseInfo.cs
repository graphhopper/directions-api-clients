...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GHResponseInfo :  IEquatable<GHResponseInfo>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GHResponseInfo" /> class.
        /// </summary>
        /// <param name="Copyrights">Copyrights.</param>
        /// <param name="Took">Took.</param>
        public GHResponseInfo(List<string> Copyrights = default(List<string>), int? Took = default(int?))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GHResponseInfo);
        }

        /// <summary>
        /// Returns true if GHResponseInfo instances are equal
        /// </summary>
        /// <param name="other">Instance of GHResponseInfo to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GHResponseInfo other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
