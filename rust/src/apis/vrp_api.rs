...
pub trait VrpApi {
    fn post_vrp(&self, key: &str, body: ::models::Request) -> Box<Future<Item = ::models::JobId, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>VrpApi for VrpApiClient<C> {
    fn post_vrp(&self, key: &str, body: ::models::Request) -> Box<Future<Item = ::models::JobId, Error = Error<serde_json::Value>>> {
        ...
        let query = ::url::form_urlencoded::Serializer::new(String::new())
            ...
            .finish();
        let uri_str = format!("{}/vrp/optimize{}", configuration.base_path, query);
