...
# **matrixGet**
> \OpenAPI\Client\Model\MatrixResponse matrixGet($key, $point, $from_point, $to_point, $point_hint, $from_point_hint, $to_point_hint, $out_array, $vehicle)
...
# **matrixPost**
> \OpenAPI\Client\Model\MatrixResponse matrixPost($key, $matrix_request)
...
try {
    $result = $apiInstance->matrixPost($key, $matrix_request);
    print_r($result);
} catch (Exception $e) {
