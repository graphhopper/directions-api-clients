...
namespace GraphHopper.Test
{
    ...
    public class RoutingApiTests
    {
        ...
        /// </summary>
        [Test]
        public void RouteInfoGetTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.RouteInfoGet();
