...
# Unit tests for SwaggerClient::MatrixApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MatrixApi' do
  before do
    # run before each test
    @instance = SwaggerClient::MatrixApi.new
  end
  ...
  describe 'test an instance of MatrixApi' do
    it 'should create an instact of MatrixApi' do
      expect(@instance).to be_instance_of(SwaggerClient::MatrixApi)
    end
  end
