...
/** A found path */
public class GHRouteResponsePath: JSONEncodable {
    ...
    public var points: GHResponseCoordinates?
    ...
    public var snappedWaypoints: GHResponseCoordinates?
    public var instructions: GHResponseInstructions?
