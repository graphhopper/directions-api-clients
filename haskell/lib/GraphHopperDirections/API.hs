...
type GraphHopperDirectionsAPI
    ...
    :<|> "matrix" :> QueryParam "point" (QueryList 'MultiParamArray (Text)) :> QueryParam "from_point" (QueryList 'MultiParamArray (Text)) :> QueryParam "to_point" (QueryList 'MultiParamArray (Text)) :> QueryParam "out_array" (QueryList 'MultiParamArray (Text)) :> QueryParam "point_hint" (QueryList 'MultiParamArray (Text)) :> QueryParam "to_point_hint" (QueryList 'MultiParamArray (Text)) :> QueryParam "from_point_hint" (QueryList 'MultiParamArray (Text)) :> QueryParam "vehicle" Text :> QueryParam "key" Text :> Verb 'GET 200 '[JSON] MatrixResponse -- 'matrixGet' route
