...
#import "OAIGHError.h"
#import "OAIMatrixRequest.h"
#import "OAIMatrixResponse.h"
...
-(NSURLSessionTask*) matrixGetWithKey: (NSString*) key
    ...
    if (point != nil) {
        queryParams[@"point"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: point format: @"multi"];
    }
    if (fromPoint != nil) {
        queryParams[@"from_point"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: fromPoint format: @"multi"];
    }
    if (toPoint != nil) {
        queryParams[@"to_point"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: toPoint format: @"multi"];
    }
    if (pointHint != nil) {
        queryParams[@"point_hint"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: pointHint format: @"multi"];
    }
    if (fromPointHint != nil) {
        queryParams[@"from_point_hint"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: fromPointHint format: @"multi"];
    }
    if (toPointHint != nil) {
        queryParams[@"to_point_hint"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: toPointHint format: @"multi"];
    }
    if (outArray != nil) {
        queryParams[@"out_array"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: outArray format: @"multi"];
    }
    if (vehicle != nil) {
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIMatrixResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIMatrixResponse*)data, error);
                                }
                            }];
}
