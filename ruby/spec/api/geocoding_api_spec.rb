...
# Unit tests for DirectionsApiClient::GeocodingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GeocodingApi' do
  before do
    # run before each test
    @instance = DirectionsApiClient::GeocodingApi.new
  end
  ...
  describe 'test an instance of GeocodingApi' do
    it 'should create an instance of GeocodingApi' do
      expect(@instance).to be_instance_of(DirectionsApiClient::GeocodingApi)
    end
  end
