#import "OAISolutionApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIResponse.h"


@interface OAISolutionApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAISolutionApi

NSString* kOAISolutionApiErrorDomain = @"OAISolutionApiErrorDomain";
NSInteger kOAISolutionApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) getSolutionWithKey: (NSString*) key
    ...
    if (key == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAISolutionApiErrorDomain code:kOAISolutionApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIResponse*)data, error);
                                }
                            }];
}
