...
class RouteOptimizationApi
{
     ...
     */
    public function solveVRPWithHttpInfo($body)
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                ...
                case 500:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Swagger\Client\Model\InternalErrorMessage',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solveVRPAsync($body)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function solveVRPAsyncWithHttpInfo($body)
    {
        $returnType = '\Swagger\Client\Model\JobId';
        $request = $this->solveVRPRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function solveVRPRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling solveVRP'
            );
        }
