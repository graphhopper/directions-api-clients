...
# Unit tests for DirectionsApiClient::RoutingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'RoutingApi' do
  before do
    # run before each test
    @instance = DirectionsApiClient::RoutingApi.new
  end
  ...
  describe 'test an instance of RoutingApi' do
    it 'should create an instance of RoutingApi' do
      expect(@instance).to be_instance_of(DirectionsApiClient::RoutingApi)
    end
  end
