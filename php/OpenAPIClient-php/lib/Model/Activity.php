...
class Activity implements ModelInterface, ArrayAccess
{
     ...
     * Sets type
     *
     * @param string|null $type type of activity
     *
     * @return $this
     */
     ...
     * Sets id
     *
     * @param string|null $id id referring to the underlying service or shipment, i.e. the shipment or service this activity belongs to
     *
     * @return $this
     */
     ...
     * Sets location_id
     *
     * @param string|null $location_id id that refers to address
     *
     * @return $this
     */
     ...
     * Sets arr_time
     *
     * @param int|null $arr_time arrival time at this activity in seconds
     *
     * @return $this
     */
     ...
     * Sets end_time
     *
     * @param int|null $end_time end time of and thus departure time at this activity
     *
     * @return $this
     */
     ...
     * Sets waiting_time
     *
     * @param int|null $waiting_time waiting time at this activity in seconds
     *
     * @return $this
     */
     ...
     * Sets distance
     *
     * @param int|null $distance cumulated distance from start to this activity in m
     *
     * @return $this
     */
     ...
     * Sets driving_time
     *
     * @param int|null $driving_time driving time of driver in seconds
     *
     * @return $this
     */
     ...
     * Sets load_before
     *
     * @param int[]|null $load_before Array with size/capacity dimensions before this activity
     *
     * @return $this
     */
     ...
     * Sets load_after
     *
     * @param int[]|null $load_after Array with size/capacity dimensions after this activity
     *
     * @return $this
     */
