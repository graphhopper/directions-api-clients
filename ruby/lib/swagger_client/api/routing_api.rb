...
module SwaggerClient
  class RoutingApi
    ...
    # @option opts [String] :vehicle The vehicle for which the route should be calculated. Other vehicles are foot, bike, motorcycle, hike, ...
    ...
    # @option opts [String] :weighting Which kind of &#39;best&#39; route calculation you need. Other option is &#x60;shortest&#x60; (e.g. for &#x60;vehicle&#x3D;foot&#x60; or &#x60;bike&#x60;), &#x60;short_fastest&#x60; if time and distance is expensive (e.g. for &#x60;vehicle&#x3D;truck&#x60;) and &#x60;curvature&#x60; (only for &#x60;vehicle&#x3D;motorcycle&#x60;)
    ...
    def route_get_with_http_info(point, points_encoded, key, opts = {})
      ...
      fail ArgumentError, "Missing the required parameter 'point' when calling RoutingApi.route_get" if point.nil?
      # verify the required parameter 'points_encoded' is set
      fail ArgumentError, "Missing the required parameter 'points_encoded' when calling RoutingApi.route_get" if points_encoded.nil?
      # verify the required parameter 'key' is set
      fail ArgumentError, "Missing the required parameter 'key' when calling RoutingApi.route_get" if key.nil?
      # resource path
      local_var_path = "/route".sub('{format}','json')
