...
class TimeWindow(object):
    ...
    def __init__(self, earliest=0, latest=None):  # noqa: E501
    ...
    def earliest(self):
        ...
        Specifies the opening time of the time window in seconds, i.e. the earliest time the service can start.  # noqa: E501
    ...
    def latest(self):
        ...
        Specifies the closing time of the time window in seconds, i.e. the latest time the service can start.  # noqa: E501
