...
impl CostMatrixDataInfo {
  /// Additional information for your request
  pub fn new() -> CostMatrixDataInfo {
    CostMatrixDataInfo {
      copyrights: None,
      took: None
    }
  ...
  pub fn with_copyrights(mut self, copyrights: Vec<String>) -> CostMatrixDataInfo {
    self.copyrights = Some(copyrights);
    self
  }
  ...
  pub fn with_took(mut self, took: f64) -> CostMatrixDataInfo {
    self.took = Some(took);
    self
  }
