...
class VrpApi(object):
    ...
    def post_vrp(self, key, request, **kwargs):  # noqa: E501
        ...
        >>> thread = api.post_vrp(key, request, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.post_vrp_with_http_info(key, request, **kwargs)  # noqa: E501
        else:
            (data) = self.post_vrp_with_http_info(key, request, **kwargs)  # noqa: E501
            return data

    def post_vrp_with_http_info(self, key, request, **kwargs):  # noqa: E501
        """Solves vehicle routing problems  # noqa: E501

        This endpoint for solving vehicle routing problems, i.e. traveling salesman or vehicle routing problems, and returns the solution.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.post_vrp_with_http_info(key, request, async=True)
        >>> result = thread.get()
        ...
        all_params = ['key', 'request']  # noqa: E501
        ...
        if ('request' not in params or
            ...
            raise ValueError("Missing the required parameter `request` when calling `post_vrp`")  # noqa: E501
