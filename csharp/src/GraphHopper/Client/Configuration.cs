...
namespace GraphHopper.Client
{
        ...
        public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/0.13.0/csharp";
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/0.13.0/csharp"
        ...
        {
            String report = "C# SDK (GraphHopper) Debug Report:\n";
