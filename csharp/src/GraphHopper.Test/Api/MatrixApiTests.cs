...
namespace GraphHopper.Test
{
    ...
    public class MatrixApiTests
    {
        ...
        public void CalculateMatrixTest()
        {
            ...
            // body = null;
            //var response = instance.CalculateMatrix(body);
        ...
        public void GetMatrixTest()
        {
            ...
            //bool? failFast = null;
            //var response = instance.GetMatrix(point, fromPoint, toPoint, pointHint, fromPointHint, toPointHint, snapPrevention, outArray, vehicle, failFast);
            //Assert.IsInstanceOf<MatrixResponse> (response, "response is MatrixResponse");
        }
        /// <summary>
        /// Test GetMatrixSolution
        /// </summary>
        [Test]
        public void GetMatrixSolutionTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            //string jobId = null;
            //var response = instance.GetMatrixSolution(jobId);
            //Assert.IsInstanceOf<MatrixResponse> (response, "response is MatrixResponse");
        }
        /// <summary>
        /// Test PostMatrix
        /// </summary>
        [Test]
        public void PostMatrixTest()
        {
            // TODO uncomment below to test the method and replace null with proper value
            // body = null;
            //var response = instance.PostMatrix(body);
            //Assert.IsInstanceOf<MatrixResponse> (response, "response is MatrixResponse");
        }
    }
