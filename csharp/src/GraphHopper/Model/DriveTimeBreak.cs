...
namespace GraphHopper.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class DriveTimeBreak :  IEquatable<DriveTimeBreak>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DriveTimeBreak" /> class.
        /// </summary>
        /// <param name="duration">Specifies the duration of the break in seconds. (required).</param>
        /// <param name="maxDrivingTime">Specifies the max driving time (in a row) without break in seconds. (required).</param>
        /// <param name="initialDrivingTime">Specifies the initial (current) driving time of a driver to allow dynamic adaptations in seconds..</param>
        /// <param name="possibleSplit">Array specifying how a break duration (in seconds) can be split into several smaller breaks.</param>
        public DriveTimeBreak(long? duration = default(long?), long? maxDrivingTime = default(long?), long? initialDrivingTime = default(long?), List<long?> possibleSplit = default(List<long?>))
        {
            // to ensure "duration" is required (not null)
            if (duration == null)
            {
                throw new InvalidDataException("duration is a required property for DriveTimeBreak and cannot be null");
            }
            else
            {
                this.Duration = duration;
            }
            // to ensure "maxDrivingTime" is required (not null)
            if (maxDrivingTime == null)
            {
                throw new InvalidDataException("maxDrivingTime is a required property for DriveTimeBreak and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Specifies the duration of the break in seconds.</value>
        ...
        /// </summary>
        /// <value>Specifies the max driving time (in a row) without break in seconds.</value>
        ...
        /// </summary>
        /// <value>Specifies the initial (current) driving time of a driver to allow dynamic adaptations in seconds.</value>
        ...
        /// </summary>
        /// <value>Array specifying how a break duration (in seconds) can be split into several smaller breaks</value>
        ...
        {
            return this.Equals(input as DriveTimeBreak);
        }

        /// <summary>
        /// Returns true if DriveTimeBreak instances are equal
        /// </summary>
        /// <param name="input">Instance of DriveTimeBreak to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DriveTimeBreak input)
        {
            if (input == null)
                return false;
