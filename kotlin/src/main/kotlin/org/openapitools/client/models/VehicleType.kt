...
data class VehicleType (
    ...
    /**
    * Profile of vehicle type
    * Values: car,bike,foot,hike,mtb,racingbike,scooter,truck,smallTruck
    */
    enum class Profile(val value: kotlin.String){
        ...
        @Json(name = "mtb") mtb("mtb"),
    
        @Json(name = "racingbike") racingbike("racingbike"),
    
        @Json(name = "scooter") scooter("scooter"),
    
        @Json(name = "truck") truck("truck"),
    
        @Json(name = "small_truck") smallTruck("small_truck");
