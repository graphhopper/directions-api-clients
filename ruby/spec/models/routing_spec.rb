...
# Unit tests for graphhopper_directions_api_client::Routing
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Routing' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::Routing.new
  end
  ...
  describe 'test an instance of Routing' do
    it 'should create an instance of Routing' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::Routing)
    end
  end
