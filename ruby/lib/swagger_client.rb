...
require 'swagger_client/models/gh_geocoding_point'
require 'swagger_client/models/gh_geocoding_response'
require 'swagger_client/models/gh_isochrone_response'
require 'swagger_client/models/gh_isochrone_response_polygon'
require 'swagger_client/models/gh_isochrone_response_polygon_geometry'
require 'swagger_client/models/gh_isochrone_response_polygon_properties'
require 'swagger_client/models/gh_matrix_request'
require 'swagger_client/models/gh_matrix_response'
require 'swagger_client/models/gh_response_coordinates'
require 'swagger_client/models/gh_response_coordinates_array'
require 'swagger_client/models/gh_response_info'
require 'swagger_client/models/gh_response_instruction'
require 'swagger_client/models/gh_response_instructions'
...
require 'swagger_client/api/route_optimization_api'
