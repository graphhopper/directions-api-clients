...
class IsochroneApi(
   ...
   */
  def getIsochrone(point: String, timeLimit: Option[Integer] = None, distanceLimit: Option[Integer] = None, vehicle: Option[VehicleProfileId] = None, buckets: Option[Integer] = None, reverseFlow: Option[Boolean] = None, weighting: Option[String] = None): Option[IsochroneResponse] = {
    val await = Try(Await.result(getIsochroneAsync(point, timeLimit, distanceLimit, vehicle, buckets, reverseFlow, weighting), Duration.Inf))
    await match {
   ...
   */
  def getIsochroneAsync(point: String, timeLimit: Option[Integer] = None, distanceLimit: Option[Integer] = None, vehicle: Option[VehicleProfileId] = None, buckets: Option[Integer] = None, reverseFlow: Option[Boolean] = None, weighting: Option[String] = None): Future[IsochroneResponse] = {
      helper.getIsochrone(point, timeLimit, distanceLimit, vehicle, buckets, reverseFlow, weighting)
  }
...
class IsochroneApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getIsochrone(point: String,
    timeLimit: Option[Integer] = None,
    distanceLimit: Option[Integer] = None,
    vehicle: Option[VehicleProfileId] = None,
    buckets: Option[Integer] = None,
    reverseFlow: Option[Boolean] = None,
    ...
    if (point == null) throw new Exception("Missing required parameter 'point' when calling IsochroneApi->getIsochrone")
