...
# **geocodeGet**
> \OpenAPI\Client\Model\GeocodingResponse geocodeGet($key, $q, $locale, $limit, $reverse, $point, $provider)
...
[**\OpenAPI\Client\Model\GeocodingResponse**](../Model/GeocodingResponse.md)
