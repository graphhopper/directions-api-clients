...
#ifndef SWGGHResponseInstructions_H_
#define SWGGHResponseInstructions_H_
...
class SWGGHResponseInstructions: public SWGObject {
public:
    SWGGHResponseInstructions();
    SWGGHResponseInstructions(QString* json);
    virtual ~SWGGHResponseInstructions();
    void init();
    void cleanup();
    ...
    SWGGHResponseInstructions* fromJson(QString &jsonString);
...
#endif /* SWGGHResponseInstructions_H_ */
