    ...
    static private func initialize() {
        dispatch_once(&once) {
            ...
            Decoders.addDecoder(clazz: Activity.self) { (source: AnyObject) -> Activity in
                ...
                instance.endDateTime = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["end_date_time"])
                instance.arrDateTime = Decoders.decodeOptional(clazz: String.self, source: sourceDictionary["arr_date_time"])
            ...
            Decoders.addDecoder(clazz: Response.self) { (source: AnyObject) -> Response in
                ...
                instance.waitingTimeInQueue = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["waiting_time_in_queue"])
            ...
            Decoders.addDecoder(clazz: Route.self) { (source: AnyObject) -> Route in
                ...
                instance.waitingTime = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["waiting_time"])
                instance.serviceDuration = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["service_duration"])
                instance.preparationTime = Decoders.decodeOptional(clazz: Int64.self, source: sourceDictionary["preparation_time"])
