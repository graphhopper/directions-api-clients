...
namespace Org.OpenAPITools.Api
{
    ...
    public interface IVrpApi : IApiAccessor
    {
        ...
        /// <param name="request">Request object that contains the problem to be solved</param>
        ...
        ApiResponse<JobId> PostVrpWithHttpInfo (string key, Request request);
        ...
        System.Threading.Tasks.Task<JobId> PostVrpAsync (string key, Request request);
        ...
        System.Threading.Tasks.Task<ApiResponse<JobId>> PostVrpAsyncWithHttpInfo (string key, Request request);
    ...
    public partial class VrpApi : IVrpApi
    {
        ...
        /// <returns></returns>
        public VrpApi(Org.OpenAPITools.Client.Configuration configuration = null)
        {
        ...
        /// <param name="request">Request object that contains the problem to be solved</param>
        /// <returns>JobId</returns>
        public JobId PostVrp (string key, Request request)
        {
             ApiResponse<JobId> localVarResponse = PostVrpWithHttpInfo(key, request);
        ...
        /// <param name="request">Request object that contains the problem to be solved</param>
        /// <returns>ApiResponse of JobId</returns>
        public ApiResponse< JobId > PostVrpWithHttpInfo (string key, Request request)
        {
            ...
            if (request == null)
                throw new ApiException(400, "Missing required parameter 'request' when calling VrpApi->PostVrp");
        ...
        /// <param name="request">Request object that contains the problem to be solved</param>
        /// <returns>Task of JobId</returns>
        public async System.Threading.Tasks.Task<JobId> PostVrpAsync (string key, Request request)
        {
             ApiResponse<JobId> localVarResponse = await PostVrpAsyncWithHttpInfo(key, request);
             return localVarResponse.Data;
        ...
        /// <param name="request">Request object that contains the problem to be solved</param>
        /// <returns>Task of ApiResponse (JobId)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<JobId>> PostVrpAsyncWithHttpInfo (string key, Request request)
        {
            // verify the required parameter 'key' is set
            if (key == null)
                throw new ApiException(400, "Missing required parameter 'key' when calling VrpApi->PostVrp");
