...
OAIMatrixApi::OAIMatrixApi(QString host, QString basePath) {
    this->host = host;
    this->basePath = basePath;
}

void
OAIMatrixApi::matrixGet(QString* key, QList<QString*>* point, QList<QString*>* from_point, QList<QString*>* to_point, QList<QString*>* point_hint, QList<QString*>* from_point_hint, QList<QString*>* to_point_hint, QList<QString*>* out_array, QString* vehicle) {
    QString fullPath;
    ...
    if (to_point_hint->size() > 0) {
      if (QString("multi").indexOf("multi") == 0) {
        foreach(QString* t, *to_point_hint) {
          if (fullPath.indexOf("?") > 0)
            fullPath.append("&");
          else
            fullPath.append("?");
          fullPath.append("to_point_hint=").append(stringValue(t));
        }
      }
      else if (QString("multi").indexOf("ssv") == 0) {
        if (fullPath.indexOf("?") > 0)
    ...
    connect(worker,
            ...
            this,
            &OAIMatrixApi::matrixGetCallback);

    worker->execute(&input);
}

void
OAIMatrixApi::matrixGetCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    ...
    OAIMatrixResponse* output = static_cast<OAIMatrixResponse*>(create(json, QString("OAIMatrixResponse")));
    auto wrapper = new OAIQObjectWrapper<OAIMatrixResponse*> (output);
    wrapper->deleteLater();
    worker->deleteLater();
...
void
OAIMatrixApi::matrixPost(QString* key, OAIMatrixRequest& oai_matrix_request) {
    QString fullPath;
    fullPath.append(this->host).append(this->basePath).append("/matrix");
    ...
    QString output = oai_matrix_request.asJson();
    ...
    connect(worker,
            &OAIHttpRequestWorker::on_execution_finished,
            this,
            &OAIMatrixApi::matrixPostCallback);

    worker->execute(&input);
}

void
OAIMatrixApi::matrixPostCallback(OAIHttpRequestWorker * worker) {
    QString msg;
    QString error_str = worker->error_str;
    QNetworkReply::NetworkError error_type = worker->error_type;
