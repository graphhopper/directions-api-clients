...
# Unit tests for graphhopper_directions_api_client::Request
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Request' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::Request.new
  end
  ...
  describe 'test an instance of Request' do
    it 'should create an instance of Request' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::Request)
    end
  end
