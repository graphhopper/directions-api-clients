...
# Unit tests for graphhopper_directions_api_client::Service
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Service' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::Service.new
  end
  ...
  describe 'test an instance of Service' do
    it 'should create an instance of Service' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::Service)
    end
  end
