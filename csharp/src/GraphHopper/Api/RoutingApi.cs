...
namespace GraphHopper.Api
{
        ...
        public interface IRoutingApi : IApiAccessor
    {
        ...
        /// <param name="snapPrevention">Optional parameter to avoid snapping to a certain road class or road environment. Currently supported values are &#x60;motorway&#x60;, &#x60;trunk&#x60;, &#x60;ferry&#x60;, &#x60;tunnel&#x60;, &#x60;bridge&#x60; and &#x60;ford&#x60;. Multiple values are specified like &#x60;snap_prevention&#x3D;ferry&amp;snap_prevention&#x3D;motorway&#x60;.  (optional)</param>
        ...
        /// <param name="pointsEncoded">Allows changing the encoding of location data in the response. The default is polyline encoding, which is compact but requires special client code to unpack. (We provide it in our JavaScript client library!) Set this parameter to &#x60;false&#x60; to switch the encoding to simple coordinate pairs like &#x60;[lon,lat]&#x60;, or &#x60;[lon,lat,elevation]&#x60;. See the description of the response format for more information.  (optional)</param>
        ...
        public partial class RoutingApi : IRoutingApi
    {
        ...
        /// <returns></returns>
        public RoutingApi(GraphHopper.Client.Configuration configuration = null)
        {
