...
@param optional (nil or map[string]interface{}) with one or more of:
    ...
    @param "vehicle" (string) The vehicle for which the route should be calculated. Other vehicles are foot, small_truck etc, see here for the details.
...
func (a *MatrixApiService) MatrixGet(ctx context.Context, key string, localVarOptionals map[string]interface{}) (MatrixResponse, *http.Response, error) {
	...
	if err := typeCheckParameter(localVarOptionals["fromPoint"], "string", "fromPoint"); err != nil {
		return successPayload, nil, err
	}
	if err := typeCheckParameter(localVarOptionals["toPoint"], "string", "toPoint"); err != nil {
		return successPayload, nil, err
	}
	...
	if localVarTempParam, localVarOk := localVarOptionals["fromPoint"].(string); localVarOk {
		localVarQueryParams.Add("from_point", parameterToString(localVarTempParam, ""))
	}
	if localVarTempParam, localVarOk := localVarOptionals["toPoint"].(string); localVarOk {
		localVarQueryParams.Add("to_point", parameterToString(localVarTempParam, ""))
	}
