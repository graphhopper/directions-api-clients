...
@implementation OAIVrpApi

NSString* kOAIVrpApiErrorDomain = @"OAIVrpApiErrorDomain";
NSInteger kOAIVrpApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) postVrpWithKey: (NSString*) key
    ...
    if (key == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIVrpApiErrorDomain code:kOAIVrpApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIJobId*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIJobId*)data, error);
                                }
                            }];
}
