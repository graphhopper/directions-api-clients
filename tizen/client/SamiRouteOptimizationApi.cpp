#include "SamiRouteOptimizationApi.h"
...
SamiRouteOptimizationApi::SamiRouteOptimizationApi() {
...
SamiResponse* 
SamiRouteOptimizationApi::getSolutionWithCompletion(String* key, String* jobId, void (* success)(SamiResponse*, SamiError*)) {
  ...
  client->execute(SamiRouteOptimizationApi::getBasePath(), url, "GET", (IMap*)queryParams, mBody, (IMap*)headerParams, null, L"application/json");
  return null;
}
...
SamiJobId* 
SamiRouteOptimizationApi::postVrpWithCompletion(String* key, SamiRequest* body, void (* success)(SamiJobId*, SamiError*)) {
  client = new SamiApiClient();
  ...
  client->execute(SamiRouteOptimizationApi::getBasePath(), url, "POST", (IMap*)queryParams, mBody, (IMap*)headerParams, null, L"application/json");
  return null;
}
