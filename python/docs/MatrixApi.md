...
# **matrix_get**
> MatrixResponse matrix_get(key, point=point, from_point=from_point, to_point=to_point, point_hint=point_hint, from_point_hint=from_point_hint, to_point_hint=to_point_hint, out_array=out_array, vehicle=vehicle)
...
try:
    # Matrix API
    api_response = api_instance.matrix_get(key, point=point, from_point=from_point, to_point=to_point, point_hint=point_hint, from_point_hint=from_point_hint, to_point_hint=to_point_hint, out_array=out_array, vehicle=vehicle)
    pprint(api_response)
