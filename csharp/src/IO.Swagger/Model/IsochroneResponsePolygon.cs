...
namespace IO.Swagger.Model
{
        ...
        public partial class IsochroneResponsePolygon :  IEquatable<IsochroneResponsePolygon>, IValidatableObject
    {
        ...
        public IsochroneResponsePolygon(IsochroneResponsePolygonProperties properties = default(IsochroneResponsePolygonProperties), string type = default(string), Polygon geometry = default(Polygon))
        {
