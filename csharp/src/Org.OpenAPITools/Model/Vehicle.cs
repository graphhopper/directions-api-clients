...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Vehicle :  IEquatable<Vehicle>, IValidatableObject
    {
        ...
        public Vehicle(string vehicleId = default(string), string typeId = default(string), Address startAddress = default(Address), Address endAddress = default(Address), Break _break = default(Break), bool? returnToDepot = default(bool?), long? earliestStart = default(long?), long? latestEnd = default(long?), List<string> skills = default(List<string>), long? maxDistance = default(long?), long? maxDrivingTime = default(long?), int? maxJobs = default(int?), int? maxActivities = default(int?))
        {
