 ...
 * @param time overall transport time in ms
 * @param transport_time overall transport time in ms
 * @param max_operation_time operation time of the longest route in ms
 * @param waiting_time total waiting time in ms
