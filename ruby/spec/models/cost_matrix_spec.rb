...
# Unit tests for graphhopper_directions_api_client::CostMatrix
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'CostMatrix' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::CostMatrix.new
  end
  ...
  describe 'test an instance of CostMatrix' do
    it 'should create an instance of CostMatrix' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::CostMatrix)
    end
  end
