...
import com.graphhopper.directions.api.client.model.BadRequest;
import com.graphhopper.directions.api.client.model.InlineResponse404;
import com.graphhopper.directions.api.client.model.InternalErrorMessage;
...
/**
 * API tests for RouteOptimizationApi
 */
@Ignore
public class RouteOptimizationApiTest {

    private final RouteOptimizationApi api = new RouteOptimizationApi();
    ...
    public void getSolutionTest() throws ApiException {
        String jobId = null;
        Response response = api.getSolution(jobId);
    ...
    public void solveVRPTest() throws ApiException {
        Request body = null;
        JobId response = api.solveVRP(body);
