...
class Stop(object):
    ...
    def __init__(self, address=None, duration=0, preparation_time=0, time_windows=None, group=None):  # noqa: E501
    ...
    def duration(self):
        ...
        Specifies the duration of the pickup or delivery in seconds, e.g. how long it takes unload items at the customer site.  # noqa: E501
    ...
    def time_windows(self):
        ...
        Specifies an array of time window objects (see time window object below). For example, if an item needs to be delivered between 7am and 10am then specify the array as follows: [ { \"earliest\": 25200, \"latest\" : 32400 } ] (starting the day from 0 in seconds).  # noqa: E501
    ...
    @property
    def group(self):
        """Gets the group of this Stop.  # noqa: E501

        Group this stop belongs to  # noqa: E501

        :return: The group of this Stop.  # noqa: E501
        :rtype: str
        """
        return self._group
    ...
    def group(self, group):
        ...
        :param group: The group of this Stop.  # noqa: E501
        :type: str
        """
