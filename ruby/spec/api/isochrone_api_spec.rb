...
# Unit tests for graphhopper_directions_api_client::IsochroneApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'IsochroneApi' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::IsochroneApi.new
  end
  ...
  describe 'test an instance of IsochroneApi' do
    it 'should create an instance of IsochroneApi' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::IsochroneApi)
    end
  end
