...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SnappedWaypoint :  IEquatable<SnappedWaypoint>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SnappedWaypoint" /> class.
        /// </summary>
        /// <param name="lon">Longitude of location..</param>
        /// <param name="lat">Latitude of location..</param>
        public SnappedWaypoint(double? lon = default(double?), double? lat = default(double?))
        {
            this.Lon = lon;
            this.Lat = lat;
        }
        ...
        {
            return this.Equals(input as SnappedWaypoint);
        }

        /// <summary>
        /// Returns true if SnappedWaypoint instances are equal
        /// </summary>
        /// <param name="input">Instance of SnappedWaypoint to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SnappedWaypoint input)
        {
            if (input == null)
                return false;
