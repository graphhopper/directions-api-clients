...
namespace IO.Swagger.Model
{
        ...
        public partial class TimeWindow :  IEquatable<TimeWindow>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="earliest">Specifies the opening time of the time window in seconds, i.e. the earliest time the service can start. (default to 0F).</param>
        /// <param name="latest">Specifies the closing time of the time window in seconds, i.e. the latest time the service can start..</param>
        public TimeWindow(long? earliest = 0F, long? latest = default(long?))
        {
            // use default value if no "earliest" provided
            if (earliest == null)
            {
                this.Earliest = 0F;
            }
        ...
        /// </summary>
        /// <value>Specifies the opening time of the time window in seconds, i.e. the earliest time the service can start.</value>
        ...
        /// </summary>
        /// <value>Specifies the closing time of the time window in seconds, i.e. the latest time the service can start.</value>
