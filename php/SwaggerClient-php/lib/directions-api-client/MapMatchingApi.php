...
/**
 * MapMatchingApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
...
class MapMatchingApi
{
    ...
    {
        list($response) = $this->postGPXWithHttpInfo();
        return $response;
    }

    /**
     * Operation postGPXWithHttpInfo
     *
     * Map-match a GPX file
     *
     *
     ...
     */
    public function postGPXWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\RouteResponse';
        $request = $this->postGPXRequest();
     ...
     */
    public function postGPXAsync()
    {
        return $this->postGPXAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation postGPXAsyncWithHttpInfo
     *
     * Map-match a GPX file
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function postGPXAsyncWithHttpInfo()
    {
        $returnType = '\Swagger\Client\Model\RouteResponse';
        $request = $this->postGPXRequest();
    ...
    /**
     * Create request for operation 'postGPX'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function postGPXRequest()
    {
