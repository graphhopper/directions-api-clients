...
/*
 * SWGResponseCoordinates.h
 * 
 * 
 */

#ifndef SWGResponseCoordinates_H_
#define SWGResponseCoordinates_H_
...
public:
    ...
    SWGResponseCoordinates(QString* json);
    virtual ~SWGResponseCoordinates();
    void init();
    void cleanup();
    ...
    SWGResponseCoordinates* fromJson(QString &jsonString);
