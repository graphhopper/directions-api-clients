...
class ModelBreak implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Break';
     ...
     * Sets earliest
     *
     * @param int|null $earliest earliest start of break
     *
     * @return $this
     */
     ...
     * Sets latest
     *
     * @param int|null $latest latest start of break
     *
     * @return $this
     */
     ...
     * Sets duration
     *
     * @param int|null $duration duration of break
     *
     * @return $this
     */
     ...
     *
     * @param int|null $max_driving_time max driving time without break
     *
     * @return $this
     */
     ...
     *
     * @param int|null $initial_driving_time initial driving time, i.e. the time your driver has already spent for driving
     *
     * @return $this
     */
     ...
     * Sets possible_split
     *
     * @param int[]|null $possible_split array of splits
     *
     * @return $this
     */
