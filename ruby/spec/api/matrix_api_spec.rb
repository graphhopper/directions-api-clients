...
# Unit tests for graphhopper_directions_api_client::MatrixApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'MatrixApi' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::MatrixApi.new
  end
  ...
  describe 'test an instance of MatrixApi' do
    it 'should create an instance of MatrixApi' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::MatrixApi)
    end
  end
