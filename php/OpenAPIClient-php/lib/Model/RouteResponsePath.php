...
class RouteResponsePath implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RouteResponsePath';
    ...
    protected static $openAPITypes = [
        ...
        'ascend' => 'double',
        'descend' => 'double',
        'points' => '\OpenAPI\Client\Model\ResponseCoordinates',
        'points_encoded' => 'bool',
        'bbox' => 'double[]',
        'snapped_waypoints' => '\OpenAPI\Client\Model\ResponseCoordinates',
        'instructions' => '\OpenAPI\Client\Model\ResponseInstructions',
        'details' => 'object'
    ];
     ...
     * Sets distance
     *
     * @param double|null $distance The total distance of the route, in meter
     *
     * @return $this
     */
     ...
     * Sets time
     *
     * @param int|null $time The total time of the route, in ms
     *
     * @return $this
     */
     ...
     * Sets ascend
     *
     * @param double|null $ascend ascend
     *
     * @return $this
     */
     ...
     * Sets descend
     *
     * @param double|null $descend The total descend (downhill) of the route, in meter
     *
     * @return $this
     */
     ...
     * Gets points
     *
     * @return \OpenAPI\Client\Model\ResponseCoordinates|null
     */
     ...
     * Sets points
     *
     * @param \OpenAPI\Client\Model\ResponseCoordinates|null $points points
     *
     * @return $this
     */
     ...
     * Sets points_encoded
     *
     * @param bool|null $points_encoded Is true if the points are encoded, if not paths[0].points contains the geo json of the path (then order is lon,lat,elevation), which is easier to handle but consumes more bandwidth compared to encoded version
     *
     * @return $this
     */
     ...
     * Sets bbox
     *
     * @param double[]|null $bbox The bounding box of the route, format <br> minLon, minLat, maxLon, maxLat
     *
     * @return $this
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ResponseCoordinates|null $snapped_waypoints snapped_waypoints
     *
     * @return $this
     */
     ...
     * Gets instructions
     *
     * @return \OpenAPI\Client\Model\ResponseInstructions|null
     */
     ...
     * Sets instructions
     *
     * @param \OpenAPI\Client\Model\ResponseInstructions|null $instructions instructions
     *
     * @return $this
     */
