...
class MatrixRequest implements ModelInterface, ArrayAccess
{
     ...
     * Sets from_points
     *
     * @param double[][]|null $from_points The starting points for the routes. E.g. if you want to calculate the three routes A-&gt;1, A-&gt;2, A-&gt;3 then you have one from_point parameter and three to_point parameters. Is a string with the format longitude,latitude.
     *
     * @return $this
     */
     ...
     * Sets to_points
     *
     * @param double[][]|null $to_points The destination points for the routes. Is a string with the format longitude,latitude.
     *
     * @return $this
     */
     ...
     * Sets point_hints
     *
     * @param string[]|null $point_hints Optional parameter. Specifies a hint for each point in the `points` array to prefer a certain street for the closest location lookup. E.g. if there is an address or house with two or more neighboring streets you can control for which street the closest location is looked up.
     *
     * @return $this
     */
     ...
     *
     * @param string[]|null $from_point_hints More information for the `from_points` array. See `point_hints`
     *
     * @return $this
     */
     ...
     * Sets to_point_hints
     *
     * @param string[]|null $to_point_hints More information for the `to_points` array. See `point_hints`
     *
     * @return $this
     */
     ...
     * Sets vehicle
     *
     * @param string|null $vehicle The vehicle for which the route should be calculated. Other vehicles are foot, small_truck etc, see here for the details.
     *
     * @return $this
     */
