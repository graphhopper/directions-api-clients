...
SamiMatrixRequest::SamiMatrixRequest() {
    init();
}
...
SamiMatrixRequest*
SamiMatrixRequest::fromJson(String* json) {
    this->cleanup();
...
void
SamiMatrixRequest::fromJsonObject(IJsonValue* pJson) {
...
SamiMatrixRequest::SamiMatrixRequest(String* json) {
    init();
    String str(json->GetPointer());
    int length = str.GetLength();
...
JsonObject*
SamiMatrixRequest::asJsonObject() {
...
IList*
SamiMatrixRequest::getPPoints() {
    return pPoints;
}
void
SamiMatrixRequest::setPPoints(IList* pPoints) {
    this->pPoints = pPoints;
}

String*
SamiMatrixRequest::getPFromPoints() {
    return pFrom_points;
}
void
SamiMatrixRequest::setPFromPoints(String* pFrom_points) {
    this->pFrom_points = pFrom_points;
}

String*
SamiMatrixRequest::getPToPoints() {
    return pTo_points;
}
void
SamiMatrixRequest::setPToPoints(String* pTo_points) {
    this->pTo_points = pTo_points;
}

IList*
SamiMatrixRequest::getPOutArrays() {
    return pOut_arrays;
}
void
SamiMatrixRequest::setPOutArrays(IList* pOut_arrays) {
    this->pOut_arrays = pOut_arrays;
}

String*
SamiMatrixRequest::getPVehicle() {
    return pVehicle;
}
void
SamiMatrixRequest::setPVehicle(String* pVehicle) {
