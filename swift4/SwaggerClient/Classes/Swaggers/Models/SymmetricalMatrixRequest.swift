//
// SymmetricalMatrixRequest.swift
//
...
public struct SymmetricalMatrixRequest: Codable {
    ...
    public var snapPreventions: [String]?
    ...
    public init(points: [[Double]]?, pointHints: [String]?, snapPreventions: [String]?, outArrays: [String]?, vehicle: Object?, failFast: Bool?) { 
        self.points = points
        self.pointHints = pointHints
        self.snapPreventions = snapPreventions
    ...
    public enum CodingKeys: String, CodingKey { 
        ...
        case snapPreventions = "snap_preventions"
