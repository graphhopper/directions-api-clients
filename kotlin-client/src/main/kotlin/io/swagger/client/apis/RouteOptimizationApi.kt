...
import io.swagger.client.models.BadRequest
import io.swagger.client.models.InlineResponse404
import io.swagger.client.models.InternalErrorMessage
...
class RouteOptimizationApi(basePath: kotlin.String = "https://graphhopper.com/api/1") : ApiClient(basePath) {
    ...
    */
    ...
    fun getSolution(jobId: kotlin.String) : Response {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun solveVRP(body: Request) : JobId {
