...
private:
    void routeGetCallback (SWGHttpRequestWorker * worker);
...
signals:
    ...
    void routeGetSignalEFull(SWGHttpRequestWorker* worker, QNetworkReply::NetworkError error_type, QString& error_str);
