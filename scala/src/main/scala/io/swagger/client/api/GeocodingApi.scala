...
class GeocodingApi(
   ...
   */
  def getGeocode(q: Option[String] = None, locale: Option[String] = None, limit: Option[Integer] = None, reverse: Option[Boolean] = None, debug: Option[Boolean] = None, point: Option[String] = None, provider: Option[String] = None): Option[GeocodingResponse] = {
    val await = Try(Await.result(getGeocodeAsync(q, locale, limit, reverse, debug, point, provider), Duration.Inf))
    await match {
   ...
   */
  def getGeocodeAsync(q: Option[String] = None, locale: Option[String] = None, limit: Option[Integer] = None, reverse: Option[Boolean] = None, debug: Option[Boolean] = None, point: Option[String] = None, provider: Option[String] = None): Future[GeocodingResponse] = {
      helper.getGeocode(q, locale, limit, reverse, debug, point, provider)
  }
...
class GeocodingApiAsyncHelper(client: TransportClient, config: SwaggerConfig) extends ApiClient(client, config) {
  ...
  def getGeocode(q: Option[String] = None,
