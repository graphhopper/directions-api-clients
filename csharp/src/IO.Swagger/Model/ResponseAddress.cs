...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ResponseAddress :  IEquatable<ResponseAddress>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ResponseAddress" /> class.
        /// </summary>
        /// <param name="locationId">Specifies the id of the location..</param>
        ...
        /// <param name="snappedWaypoint">snappedWaypoint.</param>
        public ResponseAddress(string locationId = default(string), string name = default(string), double? lon = default(double?), double? lat = default(double?), string streetHint = default(string), SnappedWaypoint snappedWaypoint = default(SnappedWaypoint))
        {
        ...
        /// </summary>
        /// <value>Specifies the id of the location.</value>
        ...
        /// </summary>
        /// <value>Latitude of location.</value>
        ...
        /// <summary>
        /// Gets or Sets SnappedWaypoint
        /// </summary>
        [DataMember(Name="snapped_waypoint", EmitDefaultValue=false)]
        public SnappedWaypoint SnappedWaypoint { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SnappedWaypoint: ").Append(SnappedWaypoint).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as ResponseAddress);
        }

        /// <summary>
        /// Returns true if ResponseAddress instances are equal
        /// </summary>
        /// <param name="input">Instance of ResponseAddress to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ResponseAddress input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.SnappedWaypoint == input.SnappedWaypoint ||
                    (this.SnappedWaypoint != null &&
                    this.SnappedWaypoint.Equals(input.SnappedWaypoint))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SnappedWaypoint != null)
                    hashCode = hashCode * 59 + this.SnappedWaypoint.GetHashCode();
                return hashCode;
            }
        }
