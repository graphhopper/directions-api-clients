...
namespace IO.Swagger.Model
{
    ...
    public partial class IsochroneResponsePolygonGeometry :  IEquatable<IsochroneResponsePolygonGeometry>, IValidatableObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as IsochroneResponsePolygonGeometry);
        }

        /// <summary>
        /// Returns true if IsochroneResponsePolygonGeometry instances are equal
        /// </summary>
        /// <param name="other">Instance of IsochroneResponsePolygonGeometry to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IsochroneResponsePolygonGeometry other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
