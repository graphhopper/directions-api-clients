#import "OAIGeocodingApi.h"
#import "OAIQueryParamCollection.h"
#import "OAIApiClient.h"
#import "OAIGHError.h"
#import "OAIGeocodingResponse.h"


@interface OAIGeocodingApi ()

@property (nonatomic, strong, readwrite) NSMutableDictionary *mutableDefaultHeaders;

@end

@implementation OAIGeocodingApi

NSString* kOAIGeocodingApiErrorDomain = @"OAIGeocodingApiErrorDomain";
NSInteger kOAIGeocodingApiMissingParamErrorCode = 234513;
...
-(NSURLSessionTask*) geocodeGetWithKey: (NSString*) key
    ...
    if (key == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kOAIGeocodingApiErrorDomain code:kOAIGeocodingApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIGeocodingResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIGeocodingResponse*)data, error);
                                }
                            }];
}
