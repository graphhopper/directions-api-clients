...
namespace IO.Swagger.Model
{
        ...
        public partial class Address :  IEquatable<Address>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="locationId">Specifies the id of the location. (required).</param>
        /// <param name="name">Name of location..</param>
        /// <param name="lon">Longitude of location. (required).</param>
        /// <param name="lat">Latitude of location. (required).</param>
        ...
        public Address(string locationId = default(string), string name = default(string), double? lon = default(double?), double? lat = default(double?), string streetHint = default(string))
        {
            ...
            if (locationId == null)
            {
                throw new InvalidDataException("locationId is a required property for Address and cannot be null");
            }
            else
            {
            ...
            if (lon == null)
            {
                throw new InvalidDataException("lon is a required property for Address and cannot be null");
            }
            else
            {
                this.Lon = lon;
            ...
            if (lat == null)
            {
                throw new InvalidDataException("lat is a required property for Address and cannot be null");
            }
            else
            {
                this.Lat = lat;
