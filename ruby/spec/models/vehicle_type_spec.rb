...
# Unit tests for graphhopper_directions_api_client::VehicleType
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'VehicleType' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::VehicleType.new
  end
  ...
  describe 'test an instance of VehicleType' do
    it 'should create an instance of VehicleType' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::VehicleType)
    end
  end
