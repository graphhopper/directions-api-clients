...
-- | Servant type-level API, generated from the OpenAPI spec for GraphHopperDirections.
type GraphHopperDirectionsAPI
    ...
    :<|> "isochrone" :> QueryParam "point" Text :> QueryParam "time_limit" Int :> QueryParam "distance_limit" Int :> QueryParam "vehicle" Text :> QueryParam "buckets" Int :> QueryParam "reverse_flow" Bool :> QueryParam "weighting" Text :> QueryParam "key" Text :> Verb 'GET 200 '[JSON] IsochroneResponse -- 'isochroneGet' route
    :<|> "matrix" :> QueryParam "point" (QueryList 'MultiParamArray (Text)) :> QueryParam "from_point" (QueryList 'MultiParamArray (Text)) :> QueryParam "to_point" (QueryList 'MultiParamArray (Text)) :> QueryParam "point_hint" (QueryList 'MultiParamArray (Text)) :> QueryParam "from_point_hint" (QueryList 'MultiParamArray (Text)) :> QueryParam "to_point_hint" (QueryList 'MultiParamArray (Text)) :> QueryParam "out_array" (QueryList 'MultiParamArray (Text)) :> QueryParam "vehicle" Text :> QueryParam "key" Text :> Verb 'GET 200 '[JSON] MatrixResponse -- 'matrixGet' route
    :<|> "matrix" :> QueryParam "key" Text :> ReqBody '[JSON] MatrixRequest :> Verb 'POST 200 '[JSON] MatrixResponse -- 'matrixPost' route
    :<|> "route" :> QueryParam "point" (QueryList 'MultiParamArray (Text)) :> QueryParam "locale" Text :> QueryParam "instructions" Bool :> QueryParam "vehicle" Text :> QueryParam "elevation" Bool :> QueryParam "points_encoded" Bool :> QueryParam "calc_points" Bool :> QueryParam "point_hint" (QueryList 'MultiParamArray (Text)) :> QueryParam "ch.disable" Bool :> QueryParam "weighting" Text :> QueryParam "edge_traversal" Bool :> QueryParam "algorithm" Text :> QueryParam "heading" Int :> QueryParam "heading_penalty" Int :> QueryParam "pass_through" Bool :> QueryParam "details" (QueryList 'MultiParamArray (Text)) :> QueryParam "round_trip.distance" Int :> QueryParam "round_trip.seed" Integer :> QueryParam "alternative_route.max_paths" Int :> QueryParam "alternative_route.max_weight_factor" Int :> QueryParam "alternative_route.max_share_factor" Int :> QueryParam "avoid" Text :> QueryParam "key" Text :> Verb 'GET 200 '[JSON] RouteResponse -- 'routeGet' route
...
-- The backend can be used both for the client and the server. The client generated from the GraphHopperDirections OpenAPI spec
...
data GraphHopperDirectionsBackend m = GraphHopperDirectionsBackend
  ...
  , isochroneGet :: Maybe Text -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Int -> Maybe Bool -> Maybe Text -> Maybe Text -> m IsochroneResponse{- ^ The GraphHopper Isochrone API allows calculating an isochrone of a locations means to calculate 'a line connecting points at which a vehicle arrives at the same time,' see [Wikipedia](http://en.wikipedia.org/wiki/Isochrone_map). It is also called **reachability** or **walkability**.  -}
  , matrixGet :: Maybe [Text] -> Maybe [Text] -> Maybe [Text] -> Maybe [Text] -> Maybe [Text] -> Maybe [Text] -> Maybe [Text] -> Maybe Text -> Maybe Text -> m MatrixResponse{- ^ The Matrix API is part of the GraphHopper Directions API and with this API you can calculate many-to-many distances, times or routes a lot more efficient than calling the Routing API multiple times. In the Routing API we support multiple points, so called 'via points', which results in one route being calculated. The Matrix API results in NxM routes or more precise NxM weights, distances or times being calculated but is a lot faster compared to NxM single requests. The most simple example is a tourist trying to decide which pizza is close to him instead of using beeline distance she can calculate a 1x4 matrix. Or a delivery service in the need of often big NxN matrices to solve vehicle routing problems. E.g. the GraphHopper Route Optimization API uses the Matrix API under the hood to achieve this.  -}
  ...
  , routeGet :: Maybe [Text] -> Maybe Text -> Maybe Bool -> Maybe Text -> Maybe Bool -> Maybe Bool -> Maybe Bool -> Maybe [Text] -> Maybe Bool -> Maybe Text -> Maybe Bool -> Maybe Text -> Maybe Int -> Maybe Int -> Maybe Bool -> Maybe [Text] -> Maybe Int -> Maybe Integer -> Maybe Int -> Maybe Int -> Maybe Int -> Maybe Text -> Maybe Text -> m RouteResponse{- ^ The GraphHopper Routing API allows to calculate route and implement navigation via the turn instructions -}
