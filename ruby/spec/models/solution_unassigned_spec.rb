...
# Unit tests for SwaggerClient::SolutionUnassigned
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SolutionUnassigned' do
  before do
    # run before each test
    @instance = SwaggerClient::SolutionUnassigned.new
  end
  ...
  describe 'test an instance of SolutionUnassigned' do
    it 'should create an instact of SolutionUnassigned' do
      expect(@instance).to be_instance_of(SwaggerClient::SolutionUnassigned)
    end
  end
