...
class Response implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'processing_time' => 'int',
        'solution' => '\OpenAPI\Client\Model\Solution'
    ];
     ...
     * Sets job_id
     *
     * @param string|null $job_id unique identify of job - which you get when posting your request to the large problem solver
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string|null $status indicates the current status of the job
     *
     * @return $this
     */
     ...
     *
     * @param int|null $waiting_in_queue waiting time in ms
     *
     * @return $this
     */
     ...
     *
     * @param int|null $processing_time processing time in ms. if job is still waiting in queue, processing_time is 0
     *
     * @return $this
     */
     ...
     * Gets solution
     *
     * @return \OpenAPI\Client\Model\Solution|null
     */
     ...
     * Sets solution
     *
     * @param \OpenAPI\Client\Model\Solution|null $solution solution
     *
     * @return $this
     */
