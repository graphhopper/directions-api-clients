...
public:
	...
	/*! \brief Get duration of stop, i.e. time in seconds the corresponding activity takes
	 */
	long long getDuration();

	/*! \brief Set duration of stop, i.e. time in seconds the corresponding activity takes
	 */
