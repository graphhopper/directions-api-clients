...
namespace IO.Swagger.Api
{
    ...
    public partial class IsochroneApi : IIsochroneApi
    {
        ...
        public ApiResponse< GHIsochroneResponse > IsochroneGetWithHttpInfo (string point, string key, int? timeLimit = null, string vehicle = null, int? buckets = null, bool? reverseFlow = null)
        {
            ...
            return new ApiResponse<GHIsochroneResponse>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => x.Value.ToString()),
                (GHIsochroneResponse) Configuration.ApiClient.Deserialize(localVarResponse, typeof(GHIsochroneResponse)));
