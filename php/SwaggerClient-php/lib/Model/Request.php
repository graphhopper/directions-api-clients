...
'configuration' => 'getConfiguration'    ];
     ...
     * Sets vehicle_types
     *
     * @param \Swagger\Client\Model\VehicleType[] $vehicle_types Specifies the available vehicle types that are referred to by the specified vehicles.
     *
     * @return $this
     */
     ...
     * Sets services
     *
     * @param \Swagger\Client\Model\Service[] $services Specifies the available services, i.e. pickup, delivery or any other points to be visited by vehicles. Each service only involves exactly one location.
     *
     * @return $this
     */
     ...
     * Sets shipments
     *
     * @param \Swagger\Client\Model\Shipment[] $shipments Specifies the available shipments, i.e. pickup AND delivery points to be visited by vehicles subsequently. Each shipment involves exactly two locations, a pickup and a delivery location.
     *
     * @return $this
     */
     ...
     * Sets objectives
     *
     * @param \Swagger\Client\Model\Objective[] $objectives Specifies an array of objective functions. This tells the algorithm the objective of the optimization.
     *
     * @return $this
     */
     ...
     * Sets cost_matrices
     *
     * @param \Swagger\Client\Model\CostMatrix[] $cost_matrices Specifies an array of cost matrix objects. This is used if you want to provide custom distance and/or time matrix values e.g. for time-dependent or indoor routing like for warehouses.
     *
     * @return $this
     */
