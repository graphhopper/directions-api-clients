...
OAIRouting*
OAIRouting::fromJson(QString json) {
...
void
OAIRouting::fromJsonObject(QJsonObject pJson) {
    ::OpenAPI::setValue(&calc_points, pJson["calc_points"], "bool", "");
    
    ::OpenAPI::setValue(&consider_traffic, pJson["consider_traffic"], "bool", "");
    
    ::OpenAPI::setValue(&network_data_provider, pJson["network_data_provider"], "QString", "QString");
    
    ::OpenAPI::setValue(&fail_fast, pJson["fail_fast"], "bool", "");
...
bool
OAIRouting::isCalcPoints() {
    return calc_points;
}
void
OAIRouting::setCalcPoints(bool calc_points) {
    this->calc_points = calc_points;
    this->m_calc_points_isSet = true;
}

bool
OAIRouting::isConsiderTraffic() {
    return consider_traffic;
}
void
OAIRouting::setConsiderTraffic(bool consider_traffic) {
    this->consider_traffic = consider_traffic;
    this->m_consider_traffic_isSet = true;
}

QString*
OAIRouting::getNetworkDataProvider() {
    return network_data_provider;
}
void
OAIRouting::setNetworkDataProvider(QString* network_data_provider) {
    this->network_data_provider = network_data_provider;
    this->m_network_data_provider_isSet = true;
}

bool
OAIRouting::isFailFast() {
    return fail_fast;
}
void
OAIRouting::setFailFast(bool fail_fast) {
