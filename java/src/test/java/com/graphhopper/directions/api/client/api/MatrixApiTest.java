...
public class MatrixApiTest {
    ...
    public void matrixGetTest() throws ApiException {
        ...
        String vehicle = null;
        MatrixResponse response = api.matrixGet(key, point, fromPoint, toPoint, pointHint, fromPointHint, toPointHint, outArray, vehicle);
    ...
    public void matrixPostTest() throws ApiException {
        ...
        MatrixResponse response = api.matrixPost(key, matrixRequest);
