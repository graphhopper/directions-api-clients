...
open class RoutingAPI {
     ...
     */
    open class func routeGet(point: [String], pointsEncoded: Bool, key: String, locale: String? = nil, instructions: Bool? = nil, vehicle: String? = nil, elevation: Bool? = nil, calcPoints: Bool? = nil, pointHint: [String]? = nil, chDisable: Bool? = nil, weighting: String? = nil, edgeTraversal: Bool? = nil, algorithm: String? = nil, heading: Int? = nil, headingPenalty: Int? = nil, passThrough: Bool? = nil, details: [String]? = nil, roundTripDistance: Int? = nil, roundTripSeed: Int64? = nil, alternativeRouteMaxPaths: Int? = nil, alternativeRouteMaxWeightFactor: Int? = nil, alternativeRouteMaxShareFactor: Int? = nil, avoid: String? = nil, completion: @escaping ((_ data: RouteResponse?,_ error: Error?) -> Void)) {
     ...
     */
    open class func routeGetWithRequestBuilder(point: [String], pointsEncoded: Bool, key: String, locale: String? = nil, instructions: Bool? = nil, vehicle: String? = nil, elevation: Bool? = nil, calcPoints: Bool? = nil, pointHint: [String]? = nil, chDisable: Bool? = nil, weighting: String? = nil, edgeTraversal: Bool? = nil, algorithm: String? = nil, heading: Int? = nil, headingPenalty: Int? = nil, passThrough: Bool? = nil, details: [String]? = nil, roundTripDistance: Int? = nil, roundTripSeed: Int64? = nil, alternativeRouteMaxPaths: Int? = nil, alternativeRouteMaxWeightFactor: Int? = nil, alternativeRouteMaxShareFactor: Int? = nil, avoid: String? = nil) -> RequestBuilder<RouteResponse> {
        let path = "/route"
        ...
        let requestBuilder: RequestBuilder<RouteResponse>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
