...
public struct MatrixRequest: Codable {
    ...
    public init(points: [[Double]]?, fromPoints: [[Double]]?, toPoints: [[Double]]?, pointHints: [String]?, fromPointHints: [String]?, toPointHints: [String]?, outArrays: [String]?, vehicle: String?) {
        self.points = points
        self.fromPoints = fromPoints
        self.toPoints = toPoints
        self.pointHints = pointHints
