...
module GraphHopperClient
  class VrpApi
    ...
    # @return [JobId]
    def post_vrp(key, request, opts = {})
      data, _status_code, _headers = post_vrp_with_http_info(key, request, opts)
      data
    end
    ...
    def post_vrp_with_http_info(key, request, opts = {})
      ...
      if @api_client.config.client_side_validation && request.nil?
        fail ArgumentError, "Missing the required parameter 'request' when calling VrpApi.post_vrp"
      end
      # resource path
