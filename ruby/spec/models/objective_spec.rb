...
# Unit tests for graphhopper_directions_api_client::Objective
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Objective' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::Objective.new
  end
  ...
  describe 'test an instance of Objective' do
    it 'should create an instance of Objective' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::Objective)
    end
  end
