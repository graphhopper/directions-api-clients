...
# Unit tests for graphhopper_directions_api_client::Algorithm
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Algorithm' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::Algorithm.new
  end
  ...
  describe 'test an instance of Algorithm' do
    it 'should create an instance of Algorithm' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::Algorithm)
    end
  end
