...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class CostMatrix :  IEquatable<CostMatrix>, IValidatableObject
    {
        ...
        /// <param name="data">JSON data of matrix response.</param>
        /// <param name="profile">vehicle profile or empty if catch all fallback.</param>
        public CostMatrix(TypeEnum? type = default(TypeEnum?), string url = default(string), List<string> locationIds = default(List<string>), Object data = default(Object), string profile = default(string))
        {
            this.Type = type;
            this.Url = url;
        ...
        /// </summary>
        /// <value>JSON data of matrix response</value>
