...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class MatrixResponse :  IEquatable<MatrixResponse>, IValidatableObject
    {
        ...
        public MatrixResponse(List<List<double?>> distances = default(List<List<double?>>), List<List<double?>> times = default(List<List<double?>>), List<List<double?>> weights = default(List<List<double?>>), ResponseInfo info = default(ResponseInfo))
        {
