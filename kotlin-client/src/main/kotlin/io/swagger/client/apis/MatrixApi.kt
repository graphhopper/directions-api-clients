...
import io.swagger.client.models.VehicleProfileId
...
class MatrixApi(basePath: kotlin.String = "https://graphhopper.com/api/1") : ApiClient(basePath) {
    ...
    */
    ...
    fun calculateMatrix(body: kotlin.Any) : JobId {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getMatrix(point: kotlin.Array<kotlin.String>, fromPoint: kotlin.Array<kotlin.String>, toPoint: kotlin.Array<kotlin.String>, pointHint: kotlin.Array<kotlin.String>, fromPointHint: kotlin.Array<kotlin.String>, toPointHint: kotlin.Array<kotlin.String>, snapPrevention: kotlin.Array<kotlin.String>, outArray: kotlin.Array<kotlin.String>, vehicle: VehicleProfileId, failFast: kotlin.Boolean) : MatrixResponse {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf("point" to toMultiValue(point.toList(), "multi"), "from_point" to toMultiValue(fromPoint.toList(), "multi"), "to_point" to toMultiValue(toPoint.toList(), "multi"), "point_hint" to toMultiValue(pointHint.toList(), "multi"), "from_point_hint" to toMultiValue(fromPointHint.toList(), "multi"), "to_point_hint" to toMultiValue(toPointHint.toList(), "multi"), "snap_prevention" to toMultiValue(snapPrevention.toList(), "multi"), "out_array" to toMultiValue(outArray.toList(), "multi"), "vehicle" to listOf("$vehicle"), "fail_fast" to listOf("$failFast"))
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/matrix",
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getMatrixSolution(jobId: kotlin.String) : MatrixResponse {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
            RequestMethod.GET,
            "/matrix/solution/{jobId}".replace("{"+"jobId"+"}", "$jobId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<MatrixResponse>(
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun postMatrix(body: kotlin.Any) : MatrixResponse {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mapOf()
        val localVariableHeaders: kotlin.collections.Map<kotlin.String,kotlin.String> = mapOf()
        val localVariableConfig = RequestConfig(
