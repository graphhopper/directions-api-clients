...
-(NSURLSessionTask*) routeGetWithPoint: (NSArray<NSString*>*) point
    ...
    if (details != nil) {
        queryParams[@"details"] = [[OAIQueryParamCollection alloc] initWithValuesAndFormat: details format: @"multi"];
    }
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"OAIRouteResponse*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((OAIRouteResponse*)data, error);
                                }
                            }];
}
