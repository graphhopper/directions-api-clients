...
namespace GraphHopper.Model
{
        ...
        public partial class JobId :  IEquatable<JobId>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="jobId">UUID. Unique id for your job/request with which you can fetch your solution.</param>
        public JobId(Guid? jobId = default(Guid?))
        {
            this._JobId = jobId;
        }
        ...
        /// </summary>
        /// <value>UUID. Unique id for your job/request with which you can fetch your solution</value>
        [DataMember(Name="job_id", EmitDefaultValue=false)]
        public Guid? _JobId { get; set; }
        ...
        public bool Equals(JobId input)
        {
            ...
            return 
                (
                    this._JobId == input._JobId ||
                    (this._JobId != null &&
                    this._JobId.Equals(input._JobId))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                int hashCode = 41;
                if (this._JobId != null)
                    hashCode = hashCode * 59 + this._JobId.GetHashCode();
                return hashCode;
            }
        }
