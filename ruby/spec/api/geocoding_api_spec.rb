...
# Unit tests for graphhopper_directions_api_client::GeocodingApi
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'GeocodingApi' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::GeocodingApi.new
  end
  ...
  describe 'test an instance of GeocodingApi' do
    it 'should create an instance of GeocodingApi' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::GeocodingApi)
    end
  end
