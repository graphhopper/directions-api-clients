...
class Solution implements ModelInterface, ArrayAccess
{
     ...
     * Sets costs
     *
     * @param int|null $costs overall costs of solution
     *
     * @return $this
     */
     ...
     * Sets distance
     *
     * @param int|null $distance overall travel distance in meters
     *
     * @return $this
     */
     ...
     * Sets time
     *
     * @param int|null $time overall transport time in seconds
     *
     * @return $this
     */
     ...
     * Sets transport_time
     *
     * @param int|null $transport_time overall transport time in seconds
     *
     * @return $this
     */
     ...
     *
     * @param int|null $max_operation_time operation time of the longest route in seconds
     *
     * @return $this
     */
     ...
     * Sets waiting_time
     *
     * @param int|null $waiting_time total waiting time in seconds
     *
     * @return $this
     */
     ...
     * Sets no_vehicles
     *
     * @param int|null $no_vehicles number of employed vehicles
     *
     * @return $this
     */
     ...
     * Sets no_unassigned
     *
     * @param int|null $no_unassigned number of jobs that could not be assigned to final solution
     *
     * @return $this
     */
     ...
     * Sets routes
     *
     * @param \OpenAPI\Client\Model\Route[]|null $routes An array of routes
     *
     * @return $this
     */
     ...
     * Sets unassigned
     *
     * @param object|null $unassigned unassigned
     *
     * @return $this
     */
