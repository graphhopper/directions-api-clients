...
# Unit tests for graphhopper_directions_api_client::Stop
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Stop' do
  before do
    # run before each test
    @instance = graphhopper_directions_api_client::Stop.new
  end
  ...
  describe 'test an instance of Stop' do
    it 'should create an instance of Stop' do
      expect(@instance).to be_instance_of(graphhopper_directions_api_client::Stop)
    end
  end
