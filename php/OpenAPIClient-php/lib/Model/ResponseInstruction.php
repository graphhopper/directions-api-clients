...
class ResponseInstruction implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResponseInstruction';
     ...
     * Sets text
     *
     * @param string|null $text A description what the user has to do in order to follow the route. The language depends on the locale parameter.
     *
     * @return $this
     */
     ...
     * Sets street_name
     *
     * @param string|null $street_name The name of the street to turn onto in order to follow the route.
     *
     * @return $this
     */
     ...
     * Sets distance
     *
     * @param double|null $distance The distance for this instruction, in meter
     *
     * @return $this
     */
     ...
     * Sets time
     *
     * @param int|null $time The duration for this instruction, in ms
     *
     * @return $this
     */
     ...
     * Sets interval
     *
     * @param int[]|null $interval An array containing the first and the last index (relative to paths[0].points) of the points for this instruction. This is useful to know for which part of the route the instructions are valid.
     *
     * @return $this
     */
     ...
     * Sets sign
     *
     * @param int|null $sign A number which specifies the sign to show e.g. for right turn etc <br>TURN_SHARP_LEFT = -3<br>TURN_LEFT = -2<br>TURN_SLIGHT_LEFT = -1<br>CONTINUE_ON_STREET = 0<br>TURN_SLIGHT_RIGHT = 1<br>TURN_RIGHT = 2<br>TURN_SHARP_RIGHT = 3<br>FINISH = 4<br>VIA_REACHED = 5<br>USE_ROUNDABOUT = 6
     *
     * @return $this
     */
     ...
     *
     * @param string|null $annotation_text optional - A text describing the instruction in more detail, e.g. like surface of the way, warnings or involved costs.
     *
     * @return $this
     */
     ...
     *
     * @param int|null $annotation_importance optional - 0 stands for INFO, 1 for warning, 2 for costs, 3 for costs and warning
     *
     * @return $this
     */
     ...
     * Sets exit_number
     *
     * @param int|null $exit_number optional - Only available for USE_ROUNDABOUT instructions. The count of exits at which the route leaves the roundabout.
     *
     * @return $this
     */
     ...
     * Sets turn_angle
     *
     * @param double|null $turn_angle optional - Only available for USE_ROUNDABOUT instructions. The radian of the route within the roundabout - 0&lt;r&lt;2*PI for clockwise and -2PI&lt;r&lt;0 for counterclockwise transit. Null if the direction of rotation is undefined.
     *
     * @return $this
     */
